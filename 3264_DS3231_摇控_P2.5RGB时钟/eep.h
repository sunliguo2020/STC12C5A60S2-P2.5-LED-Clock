...
void Write_canshi(void)   //写参数到EEROM函数。
{
	  Sector_Erase(600);
	  Byte_Program(600, 0xfd);
		Byte_Program(601, XSMOD);
		Byte_Program(602, Zhi_12);
		Byte_Program(603, Liangdu);
		Byte_Program(604, Min_Liangdu);
		Byte_Program(605, Liangdu_G);
		Byte_Program(606, NTC_buchang);
		Byte_Program(607, IR_POW);
		Byte_Program(608, COLORMODE);
